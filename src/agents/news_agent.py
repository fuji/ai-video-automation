...
確認して問題なければ投稿してね！"""
    ...
    def _translate_to_japanese(self, title: str, article: str) -> dict:
        ...
        prompt = f"""以下の英語ニュースを日本語に翻訳し、短尺動画用にまとめてください。
...
```json
{{
  "headline": "メインタイトル（15文字以内）",
  "sub_headline": "サブタイトル（20文字以内、省略可）",
  "article": "動画用にまとめた本文（100-200文字）",
  "closing": "締めの一言コメント（30文字以内、感想や驚きを表現）"
}}
```"""
